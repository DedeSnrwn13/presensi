...
@section('css')
    <link href="{{ asset('css/list-teacher.css') }}" rel="stylesheet" />
@endsection
...
@section('content')
    ...
    <div class="row">
        <div class="col-md-4">
            <form action="{{ url('/admin/dashboard/teacher/list') }}" method="GET">
                        ...
                        <div class="modal-body text-center">
                            <form action="{{ route('teacher.import') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="isi justify-content-center d-flex mb-3">
                                    <i class="bi bi-file-earmark-spreadsheet-fill" style="font-size: 100px;"></i>
                                </div>
                                <span >
                                    Silahkan uploud file excel data guru yang ingin dimasukan
                                </span>
