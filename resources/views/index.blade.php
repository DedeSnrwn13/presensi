...
<div class="row" >
    ...
    <div class="col-md-4 text-center" style="margin-top: 220px;">
        ...
        <a href="{{ url('/details-of-working-hours') }}" class="btn btn-outline-info mt-3" style="font-family: Open Sans; font-style: normal; font-size: 15px;">Lihat Detail Jam Kerja</a>
    </div>
    <div class="col-md-4 offset"></div>
</div>
@endsection
